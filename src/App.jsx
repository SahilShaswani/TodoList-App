            ...
            <div className="mx-3 md:container md:mx-auto my-5 p-5 rounded-xl bg-violet-100 min-h-[80vh] md:w-[35%]">
                ...
                <div className="addTodo my-5 flex flex-col gap-4">
                    ...
                    <div className="flex">
                        ...
                        <button onClick={handleAdd} disabled={todo.length <= 3} className='bg-violet-800 hover:bg-violet-950 disabled:bg-violet-600 p-4 py-2 mx-2 text-sm font-bold text-white rounded-full '>Save</button>
                    </div>
                </div>
